...
var aux = 0;
var sintomasUser= [];
var newSintoma= ["Tos","Dolor de garganta","Mucosidad nasal","Dolor muscular","Dolor de cabeza","Fatiga", "Falta de aire", "Dolor en el pecho", "Silbido al exhalar","Escalofríos","Sudoración excesiva" ,"Taquicardias", "Perdida de voz", "Flemas con sangre", "Perdida de peso", "Amigdalas/Ganglios inflamados","Haz concluido con el test"];
var gripeUser = [];
var asmaUser = [];
var neumoniaUser =	[];
var bronquitisUser = [];
